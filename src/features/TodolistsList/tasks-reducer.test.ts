...
test("correct task should be added to correct array", () => {
    ...
    // когда отправляем параметры в объект где он определен пишем так:
...
test("title of specified task should be changed", () => {
    ...
    const action = updateTaskTC.fulfilled(updateModel, "reqestId", updateModel)
...
test("new array should be added when new todolist is added", () => {
    ...
    const action = addTodolistTC.fulfilled(todoObject, 'requestId', todoObject.todolist.title)
